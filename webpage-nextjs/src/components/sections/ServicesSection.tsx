      ...
      <div className="container" data-aos="fade-up" data-aos-duration="1500">
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Como una de las principales empresas de cronometraje deportivo en Chile, garantizamos
            una experiencia de alta calidad para los participantes. Transformamos cada competición
            en una experiencia inolvidable con nuestro servicio especializado de cronometraje de
            carreras.
          </p>
        </div>
        ...
        <div className="pt-16">
          <div className="grid xl:grid-cols-2 grid-cols-1 gap-7">
            {services.map((service, index) => (
              <div key={index}>
                <div className="bg-white flex items-center rounded gap-5 p-5 hover:shadow-lg transition-all duration-300">
                  <img src={service.image} className="w-24" alt={service.title} />
                  <div>
